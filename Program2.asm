...
main PROC
	...
	MYLOOP:
		...
		mov strToPrint2+13,"0" ; sets c-flag back to 0
		...
		END2:
			cmp ah,00h ; compares to see if there was carry flag set
			jg SETCARRY2 ; jumps to SETCARRY statement if there was something in ah(ah>0)
			jmp OVERFLOWTEST2
...
;X-Y is D2 with c-flag(0) and o-flag(0)
;
;X is CB
;Y is 37
;X+Y is 02 with c-flag(1) and o-flag(0)
;X-Y is 94 with c-flag(1) and o-flag(0)
